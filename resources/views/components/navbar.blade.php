<nav class="bg-gray-800" x-data="{ open: false }" @keydown.window.escape="open = false">
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            ...
            <a href="/"><img class="size-8" src="https://tailwindui.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company"></a>
          </div>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <!-- Profile dropdown -->
            <div @click.away="isOpen = false" x-data="{ isOpen: false }" class="relative ml-3">
              <div>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-nav-link-mobile href="/" :active="request()->is('/')" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Home</x-nav-link>
        <x-nav-link-mobile href="/posts" :active="request()->is('posts')">Blog</x-nav-link>
        <x-nav-link-mobile href="/about" :active="request()->is('about')">About</x-nav-link>
